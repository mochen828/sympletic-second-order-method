...
from torch_symplectic_adjoint import odeint_symplectic_adjoint as odesolve
...
def get_img_loader(opt, test_batch_size=1000):
    ...
    dataset_builder, root, input_dim, output_dim = {
        ...
        'cifar10': [torch_data.CIFAR100,'data/img/cifar10',[3,32,32], 10],
    }.get(opt.problem)
...
if __name__ == '__main__':
    ...
    df.to_csv("mydata/SS64.csv",index=False)
...
plt.legend()
plt.savefig("./fig/SVS.eps",dpi=600)
plt.show()
